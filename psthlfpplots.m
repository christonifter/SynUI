    ...
    if numel(unique(data.lvls))> 1 || numel(unique(data.frqs))> 1
        ...
        if isempty(VS2)
            ...
            out.lfpstatstable = table(realchanlist, lfp(1).peaks(1,:)', lfp(1).peaks(2,:)', lfp(1).peaks(3,:)', ...
                ...
                lfp(2).slopes(1,:)', lfp(2).slopes(2,:)', lfp(2).slopes(3,:)', lfp(2).slopes(4,:)', 'VariableNames', ...
                ...
                'LFP2FallSlope_mVpms', 'LFP2RiseSlope_mVpms', 'LFP2AveFallSlope_mVpms', 'LFP2AveRiseSlope_mVpms'});
            out.lfpstatstable
