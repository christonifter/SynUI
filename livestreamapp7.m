...
function livestreamapp6(app, mode) 
...
if strcmpi(mode, 'Record')
    try
        stimpanelvalues = [app.PulseDurEdit.Value; app.PulseRateEdit.Value; app.TrainOnEdit.Value; ...
            app.TrainOffEdit.Value; app.TrainRepeatsEdit.Value; app.StimFreqEdit.Value; ...
            app.StimBWEdit.Value; app.StimLevelEdit.Value; app.StimModFreqEdit.Value; ...
            app.Stim2FreqEdit.Value; app.Stim2LevelEdit.Value; app.RampEdit.Value; ...
            app.LDSPreEdit.Value; app.LDSDurEdit.Value; ...
        ...
        stimpanelnames = [{'PulseDur'}; {'PulseRate'}; {'TrainOn'}; {'TrainOff'}; {'TrainRepeats'}; ...
            {'StimFreq'}; {'StimBW'}; {'StimLevel'}; {'StimModFreq'}; {'Stim2Freq'}; {'Stim2Level'}; ...
            {'Ramp'}; {'LDSPre'}; {'LDSDur'}; {'LDSISI'}; {'LDSRepeats'}; {'LDSPostGap'}; ...
            {'LDSCFreq'}; {'LDSBW'}; {'LDSLevel'}; {'LDSModDepth'}; {'LDSModExp'}; {'LDSModFreq'}];
        stimpanelvis = [strcmp(app.PulseDurEdit.Visible, 'on'); strcmp(app.PulseRateEdit.Visible, 'on'); strcmp(app.TrainOnEdit.Visible, 'on'); ...
            strcmp(app.TrainOffEdit.Visible, 'on'); strcmp(app.TrainRepeatsEdit.Visible, 'on'); strcmp(app.StimFreqEdit.Visible, 'on'); ...
            strcmp(app.StimBWEdit.Visible, 'on'); strcmp(app.StimLevelEdit.Visible, 'on'); strcmp(app.StimModFreqEdit.Visible, 'on'); ...
            strcmp(app.Stim2FreqEdit.Visible, 'on'); strcmp(app.Stim2LevelEdit.Visible, 'on'); strcmp(app.RampEdit.Visible, 'on'); ...
            strcmp(app.LDSPreEdit.Visible, 'on'); strcmp(app.LDSDurEdit.Visible, 'on'); ...
